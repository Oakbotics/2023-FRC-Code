...
public class GoToPositionSwerveCommandReverse  {
   ...
   */
   public GoToPositionSwerveCommandReverse(DriveSubsystem driveSubsytem, LimelightSubsystem limelightSubsystem, Pose2d destination) {
    ...
    swerveControllerCommand = new SwerveControllerCommand(
        ...
        thetaController,
        m_driveSubsystem::setModuleStatesReversed,
        m_driveSubsystem);
