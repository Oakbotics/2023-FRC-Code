...
public class AutoGoForward extends SequentialCommandGroup {
   ...
   */
  public AutoGoForward(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, LimelightSubsystem limelightSubsystem) {
