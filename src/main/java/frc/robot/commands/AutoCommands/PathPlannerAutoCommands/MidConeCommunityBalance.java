...
public class MidConeCommunityBalance extends SequentialCommandGroup {

    public MidConeCommunityBalance(DriveSubsystem driveSubsystem, ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem) {
        ...
        addCommands( 
            ...
            new ArmCommandLow(armSubsystem),
            new AutoPath("CommunityBalance", velocity, driveSubsystem),
