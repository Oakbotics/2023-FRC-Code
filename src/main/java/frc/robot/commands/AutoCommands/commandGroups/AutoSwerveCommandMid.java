...
public class AutoSwerveCommandMid extends SequentialCommandGroup {
   ...
   */
  public AutoSwerveCommandMid(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, LimelightSubsystem limelightSubsystem) {
