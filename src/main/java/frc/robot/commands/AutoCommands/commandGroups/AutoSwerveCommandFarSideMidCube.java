...
public class AutoSwerveCommandFarSideMidCube extends SequentialCommandGroup {
   ...
   */
  public  AutoSwerveCommandFarSideMidCube(ArmSubsystem armSubsystem, DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, LimelightSubsystem limelightSubsystem) {
    ...
    addCommands(
        ...
        new GoToPositionSwerveReverseCommand(m_driveSubsystem, m_limelightSubsystem, new Pose2d(new Translation2d(1,0), Rotation2d.fromDegrees(0))).getAutonomousCommand(),
