...
public class OnTheFlyPath extends SequentialCommandGroup {  //Not GOing to use

    DriveSubsystem m_driveSubsystem;

    // Creates path with default velocity settings.
    public OnTheFlyPath(String path, DriveSubsystem driveSubsystem) {
    ...
    public OnTheFlyPath(String path, PathConstraints pathConstraints, DriveSubsystem driveSubsystem) {
